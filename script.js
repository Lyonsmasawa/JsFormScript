...
function createAndInsert(parent, tag, props, clear_first) {
    ...
    if (typeof parent === 'string')
        parent = document.getElementById("singlepay");
...
var form = createAndInsert('test', 'form', {
    name: 'input',
    class: "form",
    action: 'https://singlepay.com/something_goes_here/',
    method: 'POST'
}, true);

createAndInsert(form, ':text', 'Name: ');
createAndInsert(form, 'input', { type: 'text', name: 'tex', placeholder: 'Enter Email' });

createAndInsert(form, ':text', 'Password: ');
createAndInsert(form, 'input', { type: 'text', name: 'tex', placeholder: 'Password' });
